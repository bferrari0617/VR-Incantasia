...
public class PlayerScript : MonoBehaviour
{
    ...
    private const OVRInput.Button TriggerButton = OVRInput.Button.PrimaryIndexTrigger;
    ...
    void Update()
    {
        ...
        bool trigger_down = OVRInput.Get(OVRInput.Axis1D.PrimaryIndexTrigger) > 0.5f || Input.GetMouseButton(0);
        if (trigger_down)
        {
            // Trigger press start
